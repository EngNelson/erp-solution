...
export class OrderService {
              ...
              if (
                ...
                if (order) {
                  if (order.articleOrdereds.length > 0) {
                    ...
                    await this._setOrCreateOrderProcessing(
                      order,
                      OrderProcessingAction.UPDATE,
                    );
                ...
                for (const order of ordersToTreat) {
                  if (itemsToUse > 0) {
                    ...
                    if (status === AvailabilityStatus.ALL) {
                      ...
                      console.log('new order status ==== ', order.orderStatus);
  ...
  getOrderSourceFromDeliveryMode(deliveryMode: DeliveryMode): OrderSource {
