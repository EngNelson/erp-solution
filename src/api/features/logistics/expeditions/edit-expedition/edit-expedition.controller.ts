...
import { EditExpeditionService } from './edit-packages.service';
import {AddExpeditionInput} from './dto'; 

@ApiTags('expeditions')
@Controller('expeditions')
export class EditExpeditionController {
  constructor(private readonly _editExpeditionService: EditExpeditionService) {}
  ...
  async editePackages(
    ...
    return await this._editExpeditionService.editExpedition(body, user, accessToken);
  }
}
